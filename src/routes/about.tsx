...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "About Lara — Cinematographer & Storyteller" },
      { name: "description", content: "The story, philosophy, and approach behind Lara Cinematography." },
      { property: "og:title", content: "About Lara — Cinematographer" },
      { property: "og:description", content: "The story and craft behind Lara Cinematography." },
