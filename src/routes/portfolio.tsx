...
export const Route = createFileRoute("/portfolio")({
  ...
  head: () => ({
    meta: [
      { title: "Portfolio — Lara Cinematography" },
      { name: "description", content: "Wedding films, engagements, elopements, events, and commercial cinematography." },
      { property: "og:title", content: "Portfolio — Lara Cinematography" },
      { property: "og:description", content: "A selection of cinematic wedding films and editorial commissions." },
