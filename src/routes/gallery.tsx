...
export const Route = createFileRoute("/gallery")({
  ...
  head: () => ({
    meta: [
      { title: "Gallery — Lara Cinematography" },
      { name: "description", content: "Editorial stills from wedding films, engagements, portraits, and behind the scenes." },
      { property: "og:title", content: "Gallery — Lara Cinematography" },
      { property: "og:description", content: "Cinematic stills and editorial photography." },
