        ...
        <div className="grid gap-px overflow-hidden border border-border bg-border md:grid-cols-2 lg:grid-cols-3">
          {addons.map((a, i) => (
            <Reveal key={a.id} delay={(i % 3) * 0.06}>
              <div className="group flex h-full flex-col bg-background p-8 transition-colors hover:bg-cream md:p-10">
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span className="whitespace-nowrap font-serif text-lg text-gold">{a.price}</span>
                </div>
                {a.description && (
